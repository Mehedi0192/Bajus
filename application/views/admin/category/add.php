<br/><br/><br/><br/><div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal bucket-form" method="post" action="<?php echo base_url() ?>save-category">
                   ...
                   <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea rows="20" name="category_description" class="form-control " id="ccomment" name="comment" required=""></textarea>
                                        </div>
                   </div>
                     <div class="form-group">
